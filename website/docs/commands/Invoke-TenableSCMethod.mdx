...
```powershell
Invoke-TenableSCMethod [[-Endpoint] <Object>] [-Id <String>] [-Properties <Object>] [-PSType <Object>]
 [-JsonBody <Object>] [-Method <WebRequestMethod>] [-TenableUrl <Object>] [-AccessKey <Object>]
 [-SecretKey <Object>] [<CommonParameters>]
```
